...
STATE_CHAMBERS = {
    ...
    # Additional states
    'AK': [('Alaska', 'House_of_Representatives', 'State House'),
           ('Alaska', 'State_Senate', 'State Senate')],
    'CT': [('Connecticut', 'House_of_Representatives', 'State House'),
           ('Connecticut', 'State_Senate', 'State Senate')],
    'DE': [('Delaware', 'House_of_Representatives', 'State House'),
           ('Delaware', 'State_Senate', 'State Senate')],
    'FL': [('Florida', 'House_of_Representatives', 'State House'),
           ('Florida', 'State_Senate', 'State Senate')],
    'HI': [('Hawaii', 'House_of_Representatives', 'State House'),
           ('Hawaii', 'State_Senate', 'State Senate')],
    'KS': [('Kansas', 'House_of_Representatives', 'State House')],  # Senate not up in 2026
    'MA': [('Massachusetts', 'House_of_Representatives', 'State House'),
           ('Massachusetts', 'State_Senate', 'State Senate')],
    'MI': [('Michigan', 'House_of_Representatives', 'State House'),
           ('Michigan', 'State_Senate', 'State Senate')],
    'MN': [('Minnesota', 'House_of_Representatives', 'State House'),
           ('Minnesota', 'State_Senate', 'State Senate')],
    'NH': [('New_Hampshire', 'House_of_Representatives', 'State House'),
           ('New_Hampshire', 'State_Senate', 'State Senate')],
    'NY': [('New_York', 'State_Assembly', 'State House'),
           ('New_York', 'State_Senate', 'State Senate')],
    'ND': [('North_Dakota', 'House_of_Representatives', 'State House'),
           ('North_Dakota', 'State_Senate', 'State Senate')],
    'OK': [('Oklahoma', 'House_of_Representatives', 'State House'),
           ('Oklahoma', 'State_Senate', 'State Senate')],
    'RI': [('Rhode_Island', 'House_of_Representatives', 'State House'),
           ('Rhode_Island', 'State_Senate', 'State Senate')],
    'VT': [('Vermont', 'House_of_Representatives', 'State House'),
           ('Vermont', 'State_Senate', 'State Senate')],
    'WA': [('Washington', 'House_of_Representatives', 'State House'),
           ('Washington', 'State_Senate', 'State Senate')],
    'WI': [('Wisconsin', 'State_Assembly', 'State House'),
           ('Wisconsin', 'State_Senate', 'State Senate')],
    'WY': [('Wyoming', 'House_of_Representatives', 'State House'),
           ('Wyoming', 'State_Senate', 'State Senate')],
}
...
STATE_FULL_NAMES = {
    ...
    'AK': 'Alaska', 'CT': 'Connecticut', 'DE': 'Delaware',
    'FL': 'Florida', 'HI': 'Hawaii', 'KS': 'Kansas',
    'MA': 'Massachusetts', 'MI': 'Michigan', 'MN': 'Minnesota',
    'NH': 'New_Hampshire', 'NY': 'New_York', 'ND': 'North_Dakota',
    'OK': 'Oklahoma', 'RI': 'Rhode_Island', 'VT': 'Vermont',
